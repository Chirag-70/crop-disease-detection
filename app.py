...
with tabs4:
    ...
    # Load model
    model_rice = tf.keras.models.load_model(
...
with tabs1:
    ...
    model_cotton = tf.keras.models.load_model(
...
with tabs2:
    ...
    model_maize = tf.keras.models.load_model(
...
with tabs3:
    ...
    model_potato = tf.keras.models.load_model(
...
with tabs5:
    ...
    model_sugarcane = tf.keras.models.load_model(
...
with tabs6:
    ...
    model_tomato = tf.keras.models.load_model(
